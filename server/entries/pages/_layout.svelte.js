import { c as create_ssr_component, a as compute_rest_props, s as setContext, b as spread, e as escape_object, d as escape_attribute_value, f as add_attribute, g as escape, v as validate_component, h as getContext } from "../../chunks/ssr.js";
import { T as ToolbarButton } from "../../chunks/Indicator.svelte_svelte_type_style_lang.js";
...
const FooterCopyright = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { copyrightMessage: copyrightMessage2 = "All Rights Reserved." } = $$props;
  ...
  if ($$props.copyrightMessage === void 0 && $$bindings.copyrightMessage && copyrightMessage2 !== void 0)
    $$bindings.copyrightMessage(copyrightMessage2);
  return `<span${add_attribute("class", spanCls, 0)}>© ${escape(year)} ${href ? `<a${spread(
    ...
    {}
  )}>${escape(by)}</a>` : `<span class="ml-1">${escape(by)}</span>`} ${escape(copyrightMessage2)}</span> `;
});
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<header class="bg-white"><div class="mx-auto max-w-7xl py-2 sm:px-6 lg:px-8">${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {
    default: ({ hidden, toggle }) => {
      return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
        default: () => {
          return `<img src="/images/uca-logo_no-bg.png" class="mr-3 h-6 sm:h-9" alt="Uniting Church of Australia Logo"> <span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white" data-svelte-h="svelte-124olpm">The Mulch Pit</span>`;
        }
        ...
        default: () => {
          ...
          })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/blog" }, {}, {
            default: () => {
              return `Blog`;
            }
  ...
  })}</div></header> ${slots.default ? slots.default({}) : ``} ${validate_component(Footer, "Footer").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(FooterCopyright, "FooterCopyright").$$render(
        $$result,
        {
          href: "/",
          by: "Uniting Church of Australia",
          year: 2023,
          copyrightMessage
        },
        {},
